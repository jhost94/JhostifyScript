...
import Component from "./framework/components/external/Component";
import Page from "./framework/page/external/Page";
import InternalComponent from "./framework/components/internal/InternalComponent";
import InternalPage from "./framework/page/internal/InternalPage";
