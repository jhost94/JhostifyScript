 ...
 */
class InternalPage implements ID{
    constructor(private element: Element, private name: string, private components: InternalComponent[], private id: string, private doOnRender: (() => void)[] = []) {
